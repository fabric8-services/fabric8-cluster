...
Once the cluster service is running, it will be available at link:http://f8cluster-fabric8-services.${minishift ip}.nip.io/api[http://f8cluster-fabric8-services.${minishift ip}.nip.io/api].
...
However you can see auth service is running, and will be available at link:http://auth-fabric8-services.${minishift ip}.nip.io/api[http://auth-fabric8-services.${minishift ip}.nip.io/api].
