...
image:https://ci.centos.org/buildStatus/icon?job=devtools-fabric8-cluster-build-master[Jenkins,link="https://ci.centos.org/view/Devtools/job/devtools-fabric8-cluster-build-master/lastBuild/"]
...
link:https://fabric8-services.github.io/fabric8-cluster/index.html[fabric8-cluster docs].
...
link:docs/source/getting-started-win.adoc[Getting started with fabric8-cluster development on Windows].
...
----
./bin/cluster-cli generate token -H localhost:8087 --pp
----
...
See the following README in the minishift directory for instructions on running fabric8-cluster in minishift:
